...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="pull-left">Demographics: Edit</h1>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($demographic, ['route' => ['demographics.update', $demographic->id], 'method' => 'patch']) !!}

            @form_maker_object($demographic, FormMaker::getTableColumns('demographics'))
